import math
import numpy as np
from geometry import Plane, Point_2D, Point_3D, Segment_2D, Segment_3D, Vector_2D, Vector_3D, Line_2D, Line_3D, Ray_2D, Plane_Polygon
import matrix
...
def euler_to_axis_angle(angles):
  phi, theta, psi = [math.radians(angle) for angle in angles]
  R_x = np.array([[1, 0, 0],
